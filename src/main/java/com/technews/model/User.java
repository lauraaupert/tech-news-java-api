...
//Marks a persistable object so that user class can map to a table
@Entity
...
public class User implements Serializable {
    ...
    //Eager will gather all information when created. Only one list can be Eager. Lazy will gather information as needed.
